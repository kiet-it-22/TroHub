  ...
  return (
    ...
    >
      ...
      <View style={styles.actionGrid}>
        ...
        <Pressable style={styles.actionButton} onPress={() => onNavigate("tenants")}>
          <Ionicons name="person-add-outline" size={26} color={COLORS.orange} />
          <Text style={styles.actionText}>Thêm khách</Text>
        </Pressable>
